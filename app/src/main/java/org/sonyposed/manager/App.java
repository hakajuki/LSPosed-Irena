...
import org.sonyposed.manager.receivers.LSPManagerServiceHolder;
...
public class App extends Application {
    ...
    public static final String TAG = "SonyPosedManager";
    ...
    private void setCrashReport() {
        ...
        Thread.setDefaultUncaughtExceptionHandler((thread, throwable) -> {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                values.put(MediaStore.Downloads.DISPLAY_NAME, "SonyPosed_crash_report" + time.toEpochSecond() + ".zip");
    ...
    public void onCreate() {
        ...
        intentFilter.addAction("org.sonyposed.manager.NOTIFICATION");
