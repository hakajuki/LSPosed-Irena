...
import org.sonyposed.sonypd.models.UserInfo;
import org.sonyposed.manager.App;
import org.sonyposed.manager.ConfigManager;
import org.sonyposed.manager.R;
import org.sonyposed.manager.adapters.AppHelper;
import org.sonyposed.manager.databinding.FragmentPagerBinding;
import org.sonyposed.manager.databinding.ItemModuleBinding;
import org.sonyposed.manager.databinding.SwiperefreshRecyclerviewBinding;
...
import org.sonyposed.manager.util.GlideApp;
import org.sonyposed.manager.util.ModuleUtil;
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.menu_launch) {
            ...
            navController.navigate(
                    new Uri.Builder().scheme("sonyposed").authority("repo").appendQueryParameter("modulePackageName", selectedModule.packageName).build(),
