...
package org.sonyposed.manager.ui.activity;
...
import org.sonyposed.manager.databinding.ActivityMainBinding;
import org.sonyposed.manager.repo.RepoLoader;
import org.sonyposed.manager.ui.activity.base.BaseActivity;
                    ...
                    default -> {
                        ...
                        if (data != null && Objects.equals(data.getScheme(), "module")) {
                            navController.navigate(
                                    new Uri.Builder().scheme("sonyposed").authority("module").appendQueryParameter("modulePackageName", data.getHost()).appendQueryParameter("moduleUserId", String.valueOf(data.getPort())).build(),
