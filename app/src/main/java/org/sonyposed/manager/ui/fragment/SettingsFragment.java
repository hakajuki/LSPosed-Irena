...
import org.sonyposed.manager.databinding.FragmentSettingsBinding;
import org.sonyposed.manager.repo.RepoLoader;
import org.sonyposed.manager.ui.activity.MainActivity;
import org.sonyposed.manager.util.BackupUtils;
import org.sonyposed.manager.util.CloudflareDNS;
import org.sonyposed.manager.util.LangList;
import org.sonyposed.manager.util.ThemeUtil;
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            if (backup != null) {
                ...
                backup.setOnPreferenceClickListener(preference -> {
                    ...
                    try {
                        backupLauncher.launch(String.format(LocaleDelegate.getDefaultLocale(), "SonyPosed_%s.lsp", now.toString()));
                        return true;
