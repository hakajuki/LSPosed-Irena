...
public class ServiceManager {
    public static final String TAG = "SonyPosedService";
    ...
    public static void start(String[] args) {
        ...
        for (String arg : args) {
            if (arg.equals("--from-service")) {
                Log.w(TAG, "SonyPosed daemon is not started properly. Try for a late start...");
        ...
        DdmHandleAppName.setAppName("org.sonyposed.daemon", 0);
